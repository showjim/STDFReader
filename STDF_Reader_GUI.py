...
class Application(QMainWindow):  # QWidget):
    ...
    def open_parsing_single_rec(self):
        ...
        self.progress_bar.setMaximum(0)
        self.self.threaded_single_rec_parser = SingleRecParseThread(filepath[0], rec_name)
        self.self.threaded_single_rec_parser.notify_status_text.connect(self.on_update_text)
        self.self.threaded_single_rec_parser.finished.connect(self.set_progress_bar_max)
        self.self.threaded_single_rec_parser.start()
